...
#tigris::tracts(state = "TX",county = "Bexar",cb=T,year=2023)

bexar_medincome <- get_acs(geography = "tract", variables = "B19013_001",
                              state = "TX", county = "Bexar", geometry = FALSE,year = 2023)

bexar_homevalue <- get_acs(geography = "tract", variables = "B25077_001",
                              state = "TX", county = "Bexar", geometry = TRUE,year = 2023)
